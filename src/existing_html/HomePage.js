...
const HomePage = () => {
    ...
    const widthBreakpoint = 558;
    const isStacked = width < widthBreakpoint;
    const styleSmall = isStacked ? {height: "200px"} : {};
    const styleMedium = isStacked ? {height: "200px"} : {};
    const styleLarge = isStacked ? {height: "200px"} : {};

    const sch1Picture = (
        <div className="col-sm-6 info-col-less">
            <div className="sch1-picture-col picture-col" id="sch1pic" style={styleLarge}></div>
        </div>
    )

    const sch2Picture = (
        <div className="col-sm-6 col-sm-push-6 info-col-less">
            <div className="sch2-picture-col picture-col" id="sch2pic" style={styleLarge}></div>
        </div>
    )

    const projectsPicture = (
        <div className="col-sm-6 col-sm-push-6 info-col">
            <div className="project-picture-col picture-col" id="projectpic" style={styleLarge}></div>
        </div>
    )

    const groupPicture = (
        <div className="col-sm-6 info-col">
            <div className="group-picture-col picture-col" id="grouppic" style={styleMedium}></div>
        </div>
    )

    const corporatePicture = (
        <div className="col-sm-6 col-sm-push-6 info-col">
            <div className="corp-picture-col picture-col" id="corppic" style={styleMedium}></div>
        </div>
    )
    ...
    return (
        ...
        <div className="overflow">
            ...
            <div className="container-fluid">
                <div className="row info-row">
                    {isStacked ? projectsPicture : null}
                    ...
                    {isStacked ? null : projectsPicture}
                </div>
            </div>
            ...
            <div className="container-fluid panel-borderless">
                <div className="row info-row">
                    {isStacked ? corporatePicture : null}
                    ...
                    {isStacked ? null : corporatePicture}
                </div>
            </div>
        </div>
        </div>
